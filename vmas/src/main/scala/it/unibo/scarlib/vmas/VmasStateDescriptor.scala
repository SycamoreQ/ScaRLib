...
case class EpidemicStateDescriptor (
  ...
  def BilateralVolume(
                       c1: EpidemicStateDescriptor,
                       c2: EpidemicStateDescriptor
                     ): (Int, Int) = {
  ...
  def getTotalTravelVolumeBetween(
                                   country1: EpidemicStateDescriptor,
                                   country2: EpidemicStateDescriptor
                                 ): Int = {
  ...
  def getMostConnectedCountries(
                                 targetCountry: EpidemicStateDescriptor,
                                 allCountries: Seq[EpidemicStateDescriptor],
                                 topN: Int = 5
                               ): Seq[(String, Int)] = {
    allCountries
  ...
  def calculateTravelInfectionRisk(
                                    originCountry: EpidemicStateDescriptor,
                                    destinationCountry: EpidemicStateDescriptor
                                  ): Double = {
